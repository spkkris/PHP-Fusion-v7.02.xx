...
$kmfu_ustawienia = dbarray(dbquery("SELECT * FROM ".DB_KMF_USER));
	...
	$wlacz = "<img src='".INFUSIONS."kris_user_panel/img/on.png' alt='".$locale['wlacz']."' class='admin-icons'/>";
	$wylacz = "<img src='".INFUSIONS."kris_user_panel/img/off.png' alt='".$locale['wylacz']."' class='admin-icons'/>";
...
echo"<div style='text-align: center;' class='admin-message center'>".$locale['admin'].$locale['admin1']."</div>";
		...
		echo "</select>";
		echo ($kmfu_ustawienia['statystyki'] == 1 ? $wlacz : $wylacz);
		echo "</td></tr><tr>\n";
		...
		echo "</select>";
		echo ($kmfu_ustawienia['top_users'] == 1 ? $wlacz : $wylacz);
		echo "</td></tr><tr>\n";
		...
		echo "</select>";
		echo ($kmfu_ustawienia['ip_users'] == 1 ? $wlacz : $wylacz);
		echo "</td></tr><tr>\n";
		...
		echo "</select>";
		echo ($kmfu_ustawienia['admin'] == 1 ? $wlacz : $wylacz);
		echo "</td></tr><tr>\n";
		...
		echo "</select>";
		echo ($kmfu_ustawienia['menu_user'] == 1 ? $wlacz : $wylacz);
		echo "</td></tr><tr>\n";
		...
		echo "</select>";
		echo ($kmfu_ustawienia['dodaj'] == 1 ? $wlacz : $wylacz);
	echo "</td></tr><tr>\n";
		echo"</table>\n";
		echo $zapisz;
		echo "</form>\n";
